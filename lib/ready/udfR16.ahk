...
getPlayerNameWithout_() {
	return StrReplace(getPlayerName(),"_"," ")
}
getClosestPlayerNameWith_() {
	return getPlayerNameById(getClosestPlayerID())
}
getClosestPlayerNameWithout_() {
	return StrReplace(getPlayerNameById(getClosestPlayerID()),"_"," ")
}
getTargetPlayerID() {
	return getIdByPed(getTargetPed())
}
getTargetPlayerNameWith_() {
	return getPlayerNameById(getTargetPlayerId())
}
getTargetPlayerNameWithout_() {
	return StrReplace(getPlayerNameById(getTargetPlayerID()), "_", " ")
}